...
import {API_KEY, IMG_URL} from "../hook/useAnv"
import { Button } from '@mui/material'
import YouTube from 'react-youtube'
import ActorEmpty from "../assets/images/actor.webp"
      ...
      <div className="p-5 space-y-5 rounded-md border-[2px] overflow-y-auto h-[85vh] border-slate-300 w-[20%]">
        {actors.map((item, index) => (
          <div key={index} className="p-5 rounded-md bg-slate-200">
            <img onError={handleErrorImg} className='rounded-md mb-2' src={`${IMG_URL}${item.profile_path}`} alt="actors img" width={"100%"} />
